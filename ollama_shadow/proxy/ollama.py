...
logger = logging.getLogger("ollama_shadow.ollama")
...
def _detect_model_capabilities_from_show(
    ...
    # Ollama Shadow's tool loop relies on reasoning traces to validate tool calls.
...
class OllamaClient:
    ...
    def __init__(self, base_url: str | None = None,
        ...
        if not self._supports_thinking and self._supports_native_tools:
            logger.warning(
                "native_tools=True requires thinking=True (Ollama Shadow uses reasoning "
