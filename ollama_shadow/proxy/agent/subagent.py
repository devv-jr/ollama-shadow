"""Subagent system for ollama_shadow.
...
logger = logging.getLogger("ollama_shadow.subagent")
...
class SubagentCoordinator:
    ...
    async def start_recon(
        ...
        Constructs an Ollama Shadow default dependency graph (Recon -> Analyzer -> Exploiter ... -> Reporter)
