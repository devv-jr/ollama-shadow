...
logger = logging.getLogger("ollama_shadow.agent.graph")
...
class AgentGraph:
    """Directed Acyclic Graph orchestrating specialized Ollama Shadow agents."""
...
def create_default_graph(target: str, prompt: str = "") -> AgentGraph:
    """Create the standard Ollama Shadow Phase 1-to-4 graph structure."""
