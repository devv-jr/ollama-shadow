...
Public API (unchanged from the old monolithic agent.py):
    from ollama_shadow.proxy.agent import AgentLoop
    from ollama_shadow.proxy.agent import AgentEvent, AgentState, ToolExecution
...
Internal layout:
    ...
    validators.py — _ValidatorMixin (_validate_tool_args)
