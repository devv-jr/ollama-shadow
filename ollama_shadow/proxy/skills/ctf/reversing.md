...
## Ollama Shadow Docker Constraints (Headless Only)
...
- In Ollama Shadow, always execute via tool calls (`execute`, `read_file`, `create_file`) and persist every important artifact.
