...
logger = logging.getLogger("ollama_shadow.fuzzer")
...
try:
    ...
    logger.warning(
        f"Ollama Shadow fuzzer data file not found at {_data_file}. Fuzzer will be disabled. "
        "Ensure the package is installed correctly (pip install -e .)."
    )
    _fuzzer_data = {}
except json.JSONDecodeError as e:
    logger.warning(
        f"Ollama Shadow fuzzer data file is corrupted at {_data_file}: {e}. Fuzzer will be disabled."
    )
    _fuzzer_data = {}
