...
logger = logging.getLogger("ollama_shadow.web_search")

# Cache search results to avoid repeated queries
_CACHE_DIR = Path.home() / ".ollama-shadow" / "cache" / "search"
...
async def _ddg_search(query: str, max_results: int) -> dict[str, Any]:
    ...
    for attempt in range(3):
        ...
        return {
            ...
            "Configure searxng_url in ~/.ollama-shadow/config.json for better results.",
        }
