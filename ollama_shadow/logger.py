"""Logging configuration for Ollama Shadow."""
...
def setup_logging(log_file: str = "log/log.txt",
    ...
    logging.getLogger("ollama_shadow").setLevel(logging.DEBUG)

    # Log startup
    logging.info("=" * 60)
    logging.info(f"Ollama Shadow Logging Started. Writing to {log_path.absolute()}")
    logging.info("=" * 60)
